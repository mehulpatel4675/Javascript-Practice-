...
// { element.innerText = `<b>we are full stack devloper`;}
...
// console.log(elems3);
// elems3.style.color = 'black';

// // need to serch when net  beacuse select the element but can't give the border to all at one time.
