...
//  console.log(element);
 let text = document.createTextNode('new text node to call directly');//2nd fetch
//  console.log(text);
...
// element.innerHTML = '<b> this is enter with inner HTML because of bold etc teg use'
 ...
 ul.appendChild(element);
  console.log(element);
 // to use inner text or innerHTML we can separetlly create the textNode then simple call it:- fetch 2nd
...
// console.log(elem2);
// quiz
//create a heading with text as "gotocodewith harry" and create an a tag outside href='"www.codewithharry.com"
